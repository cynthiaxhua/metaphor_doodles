...
# loads the .npy image files for the CNN encoder
...
# helper function to load the images for CNN encoder
...
# This function was modified to accommodate the CNN encoder
# Takes as input image data in addition to stroke data
